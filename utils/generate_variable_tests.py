...
d0 = torch.rand(n, n, requires_grad=True)
c0 = a0 + b0
c0.backward(d0)
...
d1 = torch.rand(n, n, requires_grad=True)
c1 = a1 + b1
c1.backward(d1)
...
d2 = torch.rand(n, n, requires_grad=True)
c2 = a2 + b2
c2.backward(d2)
...
d3 = torch.rand(n, n, n, requires_grad=True)
c3 = a3 + b3
c3.backward(d3)
...
d4 = torch.rand(n, n, n, n, requires_grad=True)
c4 = a4 + b4
c4.backward(d4)
...
d5 = torch.rand(n, n, n, n, n, requires_grad=True)
c5 = a5 + b5
c5.backward(d5)
...
z1 = torch.rand(1, n, requires_grad=True)
y1 = torch.exp(x1)
y1.backward(z1)
...
z2 = torch.rand(n, 1, requires_grad=True)
y2 = torch.exp(x2)
y2.backward(z2)
...
n = 10
x0 = torch.rand(n, n, dtype=torch.double, requires_grad=True)
z0 = torch.rand(n, requires_grad=True)
...
z1 = torch.rand(n, requires_grad=True)
...
z2 = torch.rand(n // 2, requires_grad=True)
...
save_ndarray_to_file(os.path.join(dir, "x0_grad.txt"), x0.grad.detach().numpy())
x1 = torch.rand(n // 2, n, dtype=torch.double, requires_grad=True)
z1 = torch.rand(n // 2, n, requires_grad=True)
...
save_ndarray_to_file(os.path.join(dir, "x1_grad.txt"), x1.grad.detach().numpy())
x2 = torch.rand(n // 2, n, dtype=torch.double, requires_grad=True)
z2 = torch.rand(n // 2, n, requires_grad=True)
